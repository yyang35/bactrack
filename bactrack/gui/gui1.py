...
from PyQt6.QtCore import Qt, QSize, QObject, QEvent, pyqtSignal
...
class MyMainWindow(QMainWindow):
    ...
    def add_linage_layout(self):
        # Create a new QVBoxLayout
        self.rightLayout = QVBoxLayout()

        # Add a placeholder widget, e.g., a label
        placeholderLabel = QLabel("Tracking Complete")
        self.rightLayout.addWidget(placeholderLabel)
